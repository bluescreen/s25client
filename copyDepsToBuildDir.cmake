...
IF(CMAKE_HOST_UNIX)
	...
	if(EXISTS ${CMAKE_SOURCE_DIR}/S2/DATA AND EXISTS ${CMAKE_SOURCE_DIR}/S2/GFX)
		...
		message(STATUS "S2 files not found. You can have them automatically copied if you put them into ${CMAKE_SOURCE_DIR}/S2")
	endif()
ELSE()
